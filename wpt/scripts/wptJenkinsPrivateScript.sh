...
WPT_TEST_URL="http://perfhub.stubcorp.dev:9494/runtest.php"
WPT_HAR_DOWNLOAD_URL="http://perfhub.stubcorp.dev:9494/export.php"
WPT_TEST_STATUS_URL="http://perfhub.stubcorp.dev:9494/testStatus.php?f=xml"
...
curl -s "$WPT_TEST_URL?location=$LOCATION&runs=$RUNS&f=xml&video=$VIDEO&fvonly=$FVONLY&private=$PRIVATE&label=$LABEL&mobile=$MOBILE&script=$SCRIPT_DATA" > $WORKING_DIR/$RESULT_FILE
